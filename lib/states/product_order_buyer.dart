...
class _ProductOrderBuyerState extends State<ProductOrderBuyer> {
  ...
  Widget newContent() {
    return SingleChildScrollView(
      child: Column(
        children: [
          const ShowTitle(title: 'รายการสั่งสินค้า'),
          ListView.builder(
            shrinkWrap: true,
                    ...
                    ShowButton(
                      ...
                      pressFunc: () {
                        MyDialog(context: context).actionDialog(
                            ...
                            message:
                                'ยืนยันยกเลิก การสั้งซื่อจากร้าน ${sellerUserModels[index].name} ใช่ไหม ?',
                            label1: 'ยืนยัน',
                            label2: 'ไม่ยืนยัน',
                            presFunc1: () {
                              Navigator.pop(context);
                              processUpdateStatus(docIdOrder: docIdOrders[index]);
                            },
                            presFunc2: () {
                              Navigator.pop(context);
                            });
